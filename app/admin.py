...
class BillAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'client', 'money', 'currency')
    list_filter = ('client', 'currency')


class CardAdmin(admin.ModelAdmin):

    list_display = ('id', 'bill', 'limit')
    list_filter = ('bill',)


class MessageAdmin(admin.ModelAdmin):

    list_display = ('id', 'message', 'header', 'readed', 'user', 'date')
...
class ActionAdmin(admin.ModelAdmin):
    ...
    list_display = ('id', 'actionType', 'contract', 'datetime', 'money')
    list_filter = ('actionType', 'contract', 'datetime')


class ExchangeRateAdmin(admin.ModelAdmin):

    list_display = ('id', 'date', 'from_currency', 'to_currency', 'index')
